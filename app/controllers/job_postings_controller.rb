class JobPostingsController < ApplicationController
  ...
  def index
    @job_postings = current_organization.job_postings.all
  end
  ...
  def new
    @job_posting = current_organization.job_postings.build
  end
  ...
  def create
    @job_posting = current_organization.job_postings.build(job_posting_params)
  ...
  private
    ...
    def job_posting_params
      params.require(:job_posting).permit(:title, :description, :responsibilities, :qualifications)
    end
end
